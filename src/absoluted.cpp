 ...
 *
 * This is the developer documentation of the reference client for an experimental digital currency called Absolute (https://www.absolutecoin.net/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (IsArgSet("-?") || IsArgSet("-h") ||  IsArgSet("-help") || IsArgSet("-version"))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  absoluted [options]                     " + strprintf(_("Start %s Daemon"), _(PACKAGE_NAME)) + "\n";
